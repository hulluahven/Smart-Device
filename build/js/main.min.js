...
var footerContainer = document.querySelector('[data-container]');
var mainNav = document.querySelector('[data-nav]');
var contactsFeild = document.querySelector('[data-contacts]');
var accordeonButton = document.querySelectorAll('[data-button]');
var navButton = document.querySelector('[data-nav-button]');
var contactsButton = document.querySelector('[data-contacts-button]');
var closeButton = document.querySelector('[data-close]');
var userPhones = document.querySelectorAll('input[type=tel]');
var callOffer = document.querySelector('[data-modal]');
var pageBody = document.querySelector('[data-body]');
var popUpForm = document.querySelector('[data-message]');
var nameField = popUpForm.querySelector('input[type=text]');
var navField = document.querySelector('[data-nav-field]');
var contactsField = document.querySelector('[data-contacts-field]');
var pageForm = document.querySelectorAll('[autocomplete="off"]'); // ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var closeMessage = function closeMessage() {
    ...
    var onPopupEscapeKeydown = function onPopupEscapeKeydown(e) {
      if (e.keyCode === 27) {
  ...
  function catchFocus() {
    var modalElements = popUpForm.querySelectorAll('input, textarea, button');
    var firstFocusableElement = modalElements[0];
    var lastfocusableElement = modalElements[modalElements.length - 1];
    var keyCodeTab = 9;
