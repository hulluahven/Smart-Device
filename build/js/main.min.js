...
var formFields = popUpForm.querySelectorAll('input');
var confirmField = popUpForm.querySelector('input[type=checkbox]');
var submitForm = popUpForm.querySelector('[data-submit]'); // ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (accordeonButton) {
    accordeonButton.forEach(function (button) {
  ...
  var toLoopFocus = function toLoopFocus() {
